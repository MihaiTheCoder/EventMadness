...
namespace WorkflowApp
{
    ...
    [LinkEventToCommand(typeof(OnRandomNumberGenerated), typeof(EnterNumberComponent))]
    ...
    [LinkEventToCommand(typeof(OnMistakePrinted), typeof(EnterNumberComponent))]    
    public class GuessTheNumberFlow : AttributeFlowTemplate
    {
        ...
        protected override void RegisterCommands()
        {
            ...
            commandFactory.RegisterCommand(context => new EnterNumberComponent());
            ...
            commandFactory.RegisterCommand(context => new PrintNotANumberCommand(Get<OnNumberEntered>(context).Value));
        }
    }
}
